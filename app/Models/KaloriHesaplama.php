...
class KaloriHesaplama extends Model
{
    ...
    public function tüketilenkalori()
    {
        return $this->belongsToMany(TuketilenBesinler::class,'tuketilen_besinler_kalori_hesaplama','kalori_hesaplama_id','tuketilen_besin_id');
    }
}
